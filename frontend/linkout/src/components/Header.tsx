        ...
        <header className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 relative z-50">
            <nav className="flex justify-between items-center">
                ...
                <div className="hidden sm:flex gap-4 items-center">
                    {user ? (
                        <button
                            className="px-6 py-2 text-orange-600 hover:text-orange-700 font-medium transition flex items-center gap-2"
                        ...
                        <>
                            <button
                                className="px-6 py-2 text-orange-600 hover:text-orange-700 font-medium transition"
                                onClick={() => navigate("/login")}
                            >
                                Connexion
                            </button>
                            <button
                                className="px-6 py-2 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-full
            ...
            {menuOpen && (
                <div className="sm:hidden absolute top-full left-4 right-4 mt-2 bg-white rounded-2xl shadow-2xl border border-orange-100 overflow-hidden">
                    <div className="flex flex-col p-4 gap-3">
                        {user ? (
                            <button
                                className="w-full px-6 py-3 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-xl hover:from-orange-600 hover:to-yellow-600 font-medium shadow-lg shadow-orange-200 transition flex items-center gap-2"
                                onClick={() => {
                                    setMenuOpen(false);
                                    navigate("/profile");
                                }}
